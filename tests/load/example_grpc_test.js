...
export const options = {
    ...
    thresholds: {
        ...
        'grpc_req_duration{rpc:ListFruits}': ['p(95)<500'],
        'grpc_req_duration{rpc:GetFruit}': ['p(95)<300'],
...
function createFruit(client) {
    ...
    requestDuration.add(duration, { rpc: 'CreateFruit' });
...
function updateFruit(client, id) {
    ...
    requestDuration.add(duration, { rpc: 'UpdateFruit' });
...
function deleteFruit(client, id) {
    ...
    requestDuration.add(duration, { rpc: 'DeleteFruit' });
...
function getFruitById(client, id) {
    ...
    requestDuration.add(duration, { rpc: 'GetFruit' });
...
function getFruits(client, limit = 10, offset = 0) {
    ...
    requestDuration.add(duration, { rpc: 'ListFruits' });
