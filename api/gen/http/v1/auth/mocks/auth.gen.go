...
// Source: gen/http/v1/auth/auth.gen.go
//
// Generated by this command:
//
//	mockgen -source gen/http/v1/auth/auth.gen.go -package mocks -destination gen/http/v1/auth/mocks/auth.gen.go
//
...
import (
	...
	client "github.com/hasansino/go42/api/gen/http/v1/auth"
...
func (m *MockClientInterface) Login(ctx context.Context, body client.LoginJSONRequestBody, reqEditors ...client.RequestEditorFn) (*http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockClientInterface) LoginWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...client.RequestEditorFn) (*http.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockClientWithResponsesInterface) LoginWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...client.RequestEditorFn) (*client.LoginResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, contentType, body}
	for _, a := range reqEditors {
		varargs = append(varargs, a)
...
func (m *MockClientWithResponsesInterface) LoginWithResponse(ctx context.Context, body client.LoginJSONRequestBody, reqEditors ...client.RequestEditorFn) (*client.LoginResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, body}
	for _, a := range reqEditors {
		varargs = append(varargs, a)
