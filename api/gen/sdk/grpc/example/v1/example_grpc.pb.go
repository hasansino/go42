...
const (
	ExampleService_ListFruits_FullMethodName  = "/example.v1.ExampleService/ListFruits"
	ExampleService_GetFruit_FullMethodName    = "/example.v1.ExampleService/GetFruit"
	ExampleService_CreateFruit_FullMethodName = "/example.v1.ExampleService/CreateFruit"
	ExampleService_UpdateFruit_FullMethodName = "/example.v1.ExampleService/UpdateFruit"
	ExampleService_DeleteFruit_FullMethodName = "/example.v1.ExampleService/DeleteFruit"
)
...
type ExampleServiceClient interface {
	...
	GetFruit(ctx context.Context, in *GetFruitRequest, opts ...grpc.CallOption) (*GetFruitResponse, error)
...
func (c *exampleServiceClient) GetFruit(ctx context.Context, in *GetFruitRequest, opts ...grpc.CallOption) (*GetFruitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFruitResponse)
...
type ExampleServiceServer interface {
	...
	GetFruit(context.Context, *GetFruitRequest) (*GetFruitResponse, error)
...
func (UnimplementedExampleServiceServer) GetFruit(context.Context, *GetFruitRequest) (*GetFruitResponse, error) {
