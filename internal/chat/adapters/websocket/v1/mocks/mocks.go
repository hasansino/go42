...
func (m *MockserviceAccessor) CreateRoom(ctx context.Context, data *domain.CreateRoomData, creatorID int, creatorUUID, creatorEmail string) (*domain.Room, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRoom", ctx, data, creatorID, creatorUUID, creatorEmail)
...
func (mr *MockserviceAccessorMockRecorder) CreateRoom(ctx, data, creatorID, creatorUUID, creatorEmail any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRoom", reflect.TypeOf((*MockserviceAccessor)(nil).CreateRoom), ctx, data, creatorID, creatorUUID, creatorEmail)
}
...
// MockauthServiceAccessor is a mock of authServiceAccessor interface.
type MockauthServiceAccessor struct {
	ctrl     *gomock.Controller
	recorder *MockauthServiceAccessorMockRecorder
	isgomock struct{}
}

// MockauthServiceAccessorMockRecorder is the mock recorder for MockauthServiceAccessor.
type MockauthServiceAccessorMockRecorder struct {
	mock *MockauthServiceAccessor
}

// NewMockauthServiceAccessor creates a new mock instance.
func NewMockauthServiceAccessor(ctrl *gomock.Controller) *MockauthServiceAccessor {
	mock := &MockauthServiceAccessor{ctrl: ctrl}
	mock.recorder = &MockauthServiceAccessorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockauthServiceAccessor) EXPECT() *MockauthServiceAccessorMockRecorder {
	return m.recorder
}

// GetUserByID mocks base method.
func (m *MockauthServiceAccessor) GetUserByID(ctx context.Context, id int) (*models.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockauthServiceAccessorMockRecorder) GetUserByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByID", reflect.TypeOf((*MockauthServiceAccessor)(nil).GetUserByID), ctx, id)
}
